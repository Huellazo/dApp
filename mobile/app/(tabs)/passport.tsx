...
export default function PassportScreen() {
  return (
    <ScrollView className="flex-1 bg-background pt-12 px-4 pb-24">
      <Text className="text-3xl font-black text-border mb-6 uppercase tracking-tight">Mi Pasaporte</Text>
      ...
      <BrutalistCard colorClass="bg-secondary mb-8 p-0 overflow-hidden">
        <View className="bg-primary p-4 border-b-4 border-border flex-row items-center justify-between">
          <Text className="text-border font-black text-xl uppercase">Nivel: {MOCK_USER.passportLevel}</Text>
          <View className="bg-background px-2 py-1 border-2 border-border shadow-brutal-sm">
            <Text className="text-border font-bold text-xs uppercase">Viajero</Text>
          </View>
        </View>
        <View className="p-4 bg-background">
          <Text className="text-border font-bold text-xs uppercase opacity-70 mb-1">Identidad (PDA)</Text>
          ...
          <View className="flex-row justify-between mb-1">
            <Text className="text-border font-bold text-xs uppercase">Progreso</Text>
      ...
      <Text className="text-xl font-black text-border mb-4 uppercase">Sellos y Trofeos</Text>
