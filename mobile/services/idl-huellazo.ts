  ...
  "instructions": [
    ...
    },
    {
      ...
      "accounts": [
        ...
        { "name": "merchantAuthority", "isMut": false, "isSigner": false },
        { "name": "config", "isMut": true, "isSigner": false },
        { "name": "admin", "isMut": true, "isSigner": true },
        { "name": "systemProgram", "isMut": false, "isSigner": false }
      ],
    ...
    },
    {
      ...
      "type": {
        ...
        "fields": [
          ...
          { "name": "fidelityPoints", "type": "u64" },
          { "name": "ecoFlags", "type": "u8" },
          { "name": "bump", "type": "u8" }
        ]
      }
    },
